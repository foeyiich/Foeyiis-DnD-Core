...
//                (long) baseDamage + AbilityScore.get(attacker).getScoreModifier(DnDAbilityScoreType.STRENGTH),
//                -5,
//                5
//        );
//
...
//            baseDamage /= 2;
//        }
//        pool.addDice(DnDDamageTypes.Physical., DnDItemUtils.getDice(itemStack));
//
